...
public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
{
    ...
    /// <inheritdoc />
    public override string Name => "Apple Music (JP/US)";
    ...
    public override string Description
        => "Fetches track, album and artist metadata and artwork from the Apple Music catalog via a self-hosted backend.";
